...
const Game = (props) => {
    ...
    const onSimbiosePlayed = (played_card) => {
        ...
        console.log("entered simbiose card played ", played_card);
        console.log("played cards deck", playedCardsPile)
        ...
        if(shouldFilter1) {
            ...
            console.log("shouldfilter 1 AAAAAAAA")
            ...
            console.log("shouldfilter1 onsimbiose", shouldFilter1)
            console.log("p1 deck dps::::::::::::", player1Deck)
        }
            ...
            console.log("shouldfilter 2 BBBBBBBBB")
            console.log("remove index", removeIndex)
            socket.emit('updateGameState', {
            ...
            console.log("shouldfilter2 onsimbiose", shouldFilter2)

            console.log("p2   deck dps::::::::::::", player2Deck)
        }
    }
    ...
    const onCardPlayedHandler = (played_card) => {
        ...
        console.log("cp should filter 1:::::", shouldFilter1)
        console.log("cp should filter 2;;;;", shouldFilter2)
